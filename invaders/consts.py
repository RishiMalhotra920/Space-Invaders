...
ALIEN_SPEED = 1.0
#The factor by which to increase alien speed.
ALIEN_SPEED_INCREASE = 0.97
...
#: Defense barrier attributes
#The health of the barrier
BARRIER_HEALTH = 3600
#The y coordinates of the barrier
BARRIER_Y = DEFENSE_LINE+80
#The width of the barrier
BARRIER_WIDTH = 90
#The height of the barrier
BARRIER_HEIGHT = 40
#The amount by which to reduce the barrier health.
BARRIER_HEALTH_DECREMENT = BARRIER_HEALTH/6
